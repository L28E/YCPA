...
tSim = 200e-15
f = 230e12;
%f = 100e12; % smaller freq = thiccer waves (larger wavelength)
lambda = c_c/f;
...
% Lets make a "C" shape, boxy thing. That's kind of interesting
epi{1} = ones(nx{1},ny{1})*c_eps_0;
epi{1}(140:150,55:95)= c_eps_0*11.3;
epi{1}(100:150,55:60)= c_eps_0*11.3;
epi{1}(100:150,90:95)= c_eps_0*11.3;
epi{1}(100:110,55:65)= c_eps_0*11.3;
epi{1}(100:110,85:95)= c_eps_0*11.3;
